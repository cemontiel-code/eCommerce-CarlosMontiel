...
const CartContainer = () => {
  ...
  return (
    <div
      ...
      className="md:min-h-[93%] bg-opacity-50  backdrop-blur-md"
    >
      <div className="hero-overlay md:flex gap-5 ">
        <div className="card mx-auto md:w-8/12 md:h-[92%] md:mt-5 p-2 bg-gray-200 bg-opacity-50 backdrop-blur-xl">
          <h2 className="card-title"> Carrito </h2>
          <div className="card-body  ">
            {cartState ? (
              <ul className="md:overflow-y-scroll h-[60%] ">
                {cart.map((cartItem) => (
                  <li key={cartItem.id}>
                    <div className="bg-white bg-opacity-80 shadow-inner p-2 gap-2 m-4">
                      ...
                      <div className="flex gap-3 content-end bg-red-400">
                        <div className="block ">
                          <b>Subtotal</b>
                          <br />
          ...
          <div className="card-actions justify-end mt-auto">
            {cartState ? (
              <>
                <button
                  className="btn gap-2 btn-sm btn-warning"
                  onClick={() => {
                    deleteCart();
                  }}
                >
